...
class SignUp:
    def __init__(self, root):
        ...
        self.bg_img = ImageTk.PhotoImage(file="images/s-class.jpeg")
        ...
        if self.fname_txt.get()=="" or self.lname_txt.get()=="" or self.email_txt.get()=="" or self.questions.get()=="Select" or self.answer_txt.get()=="" or self.password_txt.get() == "":
            ...
            try:
                ...
                if row!=None:
                    ...
                    cur.execute("INSERT INTO login (fname,lname,email,question,answer,password) values(%s,%s,%s,%s,%s,%s)",
                                    (
                                        self.fname_txt.get(),
                                        self.lname_txt.get(),
                                        self.email_txt.get(),
